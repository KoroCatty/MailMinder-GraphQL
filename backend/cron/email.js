...
//! Send Email 10:00 AM every day
// const sendEmail = cron.schedule('0 10 * * *', async () => {
...
//! Send Email at 8:00 AM and 8:00 PM JST every day (日本時間)
const sendEmail = cron.schedule('0 23,11 * * *', async () => {
  try {
